...
Module Funciones
    ...
    Public vCerrar, vGrafico, vGraficoSolo, vNumeros, vNotas, vPathExportar, vConcepto As String
    ...
    Public Sub TraducirGridApuntesBD(ByVal dgv As DataGridView)
        ...
        For Each fila As DataGridViewRow In dgv.Rows
            ...
            ' ---------------------------------------------------------------------
            ' Leemos directamente el código que ya inyecta tu SQL en la celda 8, evitando consultas lentas
            If fila.Cells.Count > 8 AndAlso fila.Cells(8).Value IsNot Nothing AndAlso Not IsDBNull(fila.Cells(8).Value) Then
                Dim codigoCortoMaestro As String = fila.Cells(8).Value.ToString().Trim().ToUpper()
                ...
                If Not String.IsNullOrEmpty(codigoCortoMaestro) Then
                    ...
                    If recursos IsNot Nothing Then
                        ' 1. Leemos todas las variantes posibles del archivo de recursos
                    ...
                    ' Si el traductor encontró éxito, estampamos la traducción oficial en mayúsculas comerciales
                    If Not String.IsNullOrEmpty(traduccionFinal) Then
                        fila.Cells(1).Value = traduccionFinal.ToUpper()
                    Else
                        ' Si no hay traducción (como en tu BD llena con "ALIMENTACIÓ"), se respeta el texto bruto original

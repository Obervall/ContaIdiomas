...
Public Class SeleccionDatosIngresos
    ...
    Private Sub SeleccionDatos_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        cmdMySql1cr.CommandText += "Where conceptos.TipoCON = 'INGRESO' ORDER BY conceptos.CodigoCON ASC"
        Try
        ...
        Catch ex As Exception
            MsgBox("Error al cargar el ListBox de Conceptos de Ingresos" & vbCrLf & ex.ToString)
        End Try
    End Sub

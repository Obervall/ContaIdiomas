...
Public Class GraficosFechas3D
    ...
    Private Sub PrintDocument1_PrintPage(sender As Object, e As PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        '*************************************************************
        e.Graphics.DrawString(frmGraficosFechas3D.Chart1.Titles.Item(0).Text, FuenteTitulo, Brushes.Black, frmImprimirForm.LblUsuario.Left, frmImprimirForm.LblUsuario.Top)
        ...
        b = New Bitmap(frmGraficosFechas3D.Chart1.Width, frmGraficosFechas3D.Chart1.Height)
        frmGraficosFechas3D.Chart1.DrawToBitmap(b, New Rectangle(0, 0, b.Width, b.Height))

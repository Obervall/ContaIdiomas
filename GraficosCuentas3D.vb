...
Public Class GraficosCuentas3D
    ...
    Private Sub PrintDocument1_PrintPage(sender As Object, e As PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        '*************************************************************
        e.Graphics.DrawString(frmGraficosCuentas3D.Chart1.Titles.Item(0).Text, FuenteTitulo, Brushes.Black, frmImprimirForm.LblUsuario.Left, frmImprimirForm.LblUsuario.Top)
        ...
        b = New Bitmap(frmGraficosCuentas3D.Chart1.Width, frmGraficosCuentas3D.Chart1.Height)
        frmGraficosCuentas3D.Chart1.DrawToBitmap(b, New Rectangle(0, 0, b.Width, b.Height))
                ...
                If fila.Cells(3).Value <> 0 Then
                    ...
                    If vNombreConcepto <> fila.Cells(6).Value.ToString Then
                        ...
                        Try
                            cmdMdb1cr.ExecuteNonQuery()
                        Catch ex As Exception
                            MsgBox("Error al añadir el Concepto a Tempapu con importe diferente a cero")
                            MsgBox(ex.ToString)
                        End Try
                        vAñadir = "INSERT INTO tempapu"
                        vAñadir += "(ConceptoAPU, SumaImporteAPU) "
                        ...
                        Try
                            cmdMdb1cr.ExecuteNonQuery()
                        Catch ex As Exception
                            MsgBox("Error al añadir el Concepto a Tempapu sin condiciones")
                            MsgBox(ex.ToString)
                        End Try
                    Else ' Si el Concepto existe y hay importe diferente a cero, si es positivo o negativo se suma
                        ...
                        Try
                            ...
                            End If
                        Catch ex As Exception
                            MsgBox("Error al verificar si el Concepto existe en Tempapu con las condiciones")
                            MsgBox(ex.ToString)
                        End Try
                    End If
                End If
                ...
                If fila.Cells(3).Value <> 0 Then
                    ...
                    If vNombreConcepto <> fila.Cells(6).Value.ToString Then
                        ...
                        Try
                            cmdMdb1cr.ExecuteNonQuery()
                        Catch ex As Exception
                            MsgBox("Error al añadir el Concepto a Tempapu con las condiciones")
                            MsgBox(ex.ToString)
                        End Try
                        vAñadir = "INSERT INTO tempapu"
                        vAñadir += "(ConceptoAPU, SumaImporteAPU) "
                        ...
                        Try
                            ...
                            If drMdb1.HasRows Then 'Significa que existe con las condiciones
                                ...
                                Try
                                    drMdb1 = cmdMdb1cr.ExecuteReader()
                                Catch ex As Exception
                                    MsgBox("Error al actualizar el importe del Concepto en Tempapu con las condiciones")
                                    MsgBox(ex.ToString)
                                End Try
                                drMdb1.Close()

...
Public Class GraficosMeses3D
    ...
    Private Sub PrintDocument1_PrintPage(sender As Object, e As PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        '*************************************************************
        e.Graphics.DrawString(frmGraficosMeses3D.Chart1.Titles.Item(0).Text, FuenteTitulo, Brushes.Black, frmImprimirForm.LblUsuario.Left, frmImprimirForm.LblUsuario.Top)
        ...
        b = New Bitmap(frmGraficosMeses3D.Chart1.Width, frmGraficosMeses3D.Chart1.Height)
        frmGraficosMeses3D.Chart1.DrawToBitmap(b, New Rectangle(0, 0, b.Width, b.Height))
